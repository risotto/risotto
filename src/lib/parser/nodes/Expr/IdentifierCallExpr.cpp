...
IdentifierCallExpr::IdentifierCallExpr(Token *identifier, Token *rParen, const std::vector<Expr *> &args)
...
FunctionNotFoundError IdentifierCallExpr::getFunctionNotFoundError(Compiler *compiler) {
    ...
    throw FunctionNotFoundError(identifier->lexeme, "", argumentsTypes, rParen);
}
